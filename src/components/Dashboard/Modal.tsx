...
type ModalProps = {
  ...
  title: string;
  message: string;
  confirmText?: string; // Optional prop with default value
  cancelText?: string; // Optional prop with default value
};

const Modal: FC<ModalProps> = ({ isOpen, onClose, onConfirm, title, message, confirmText = "Konfirmasi", cancelText = "Batal" }) => {
  if (!isOpen) {
    return null;
  }
