// src/components/Dashboard/Notification.tsx
...
type NotificationProps = {
  message: string;
  type: "success" | "error"; // Explicitly define allowed types for 'type'
  onClose: () => void;
};

const Notification: FC<NotificationProps> = ({ message, type, onClose }) => {
  const bgColor: string = type === "success" ? "bg-green-500" : "bg-red-500";
  const icon = type === "success" ? ( // Menghapus anotasi tipe JSX.Element
