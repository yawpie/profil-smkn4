...
import type { DetailItemProps } from '@/types/DetailItemProps';

const DetailItem: React.FC<DetailItemProps> = ({ label, value, color = 'from-gray-100 to-white' }) => (
    ...
    const fetchAdminProfile = async () => {
      ...
      try {
        const dataProfile: AdminProfile = {
          id: '1', // Changed id to a string to match the updated AdminProfile interface
          name: 'Bayu Prakoso',
      ...
      } catch (err: any) { // Catching error as 'any' for now, can be more specific if needed
