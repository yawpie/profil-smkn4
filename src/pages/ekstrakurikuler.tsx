      ...
      <MainLayout>
        <section className="min-h-screen bg-slate-50 flex flex-col justify-center items-center">
          <div className="max-w-md mx-auto text-center bg-white border border-red-200 p-8">
            ...
            >
              Failed to load extracurricular activities. Please try again later. ({error})
            </motion.p>
            <button
  ...
  return (
    <MainLayout>
      <Head>
        ...
        <meta name="description" content="Comprehensive listing of extracurricular activities and programs available for student development and engagement." />
      ...
      <section className="relative bg-slate-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 sm:px-8 lg:px-12 py-24">
          ...
          >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-center">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight">
                    Extracurricular <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Activities</span>
                  </h1>
                </div>
            ...
            >
              Discover diverse opportunities that enhance student development, foster creativity, and build essential life skills beyond the traditional classroom experience.
            </motion.p>
            ...
            >
              <div className="text-center border-l border-slate-700 pl-6 first:border-l-0 first:pl-0 relative">
                ...
                <div className="text-2xl font-bold text-white">{extracurriculars.length}</div>
                <div className="text-sm text-slate-400 uppercase tracking-wide">Activities</div>
              </div>
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-4">Program Directory</h2>
            <p className="text-slate-600 text-lg">Comprehensive overview of all available extracurricular programs and activities.</p>
          </motion.div>
        ...
        <div className="relative container mx-auto px-6 sm:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-slate-300 mb-8 text-lg">Join our vibrant community of students exploring their passions and developing new skills.</p>
