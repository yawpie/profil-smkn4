      ...
      <section className="relative bg-slate-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 sm:px-8 lg:px-12 py-24">
          ...
          >
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="text-center">
                  <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight">
                    Student <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Achievements</span>
                  </h1>
                </div>
            ...
            >
              Discover our students' inspiring achievements and accomplishments at local, national, and international levels that demonstrate excellence and dedication.
            </motion.p>
            ...
            >
              <div className="text-center border-l border-slate-700 pl-6 first:border-l-0 first:pl-0">
                ...
                <div className="text-sm text-slate-400 uppercase tracking-wide">Total Achievements</div>
              </div>
              <div className="text-center border-l border-slate-700 pl-6">
                ...
                <div className="text-sm text-slate-400 uppercase tracking-wide">Current Year</div>
              </div>
              <div className="text-center border-l border-slate-700 pl-6">
                <div className="text-2xl font-bold text-white">Excellence</div>
                <div className="text-sm text-slate-400 uppercase tracking-wide">Standard</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            <div className="max-w-7xl mx-auto text-center mb-12">
              ...
              <h2 className="text-2xl font-semibold text-slate-900 mb-2">Loading Achievements</h2>
              <p className="text-slate-600">Please wait while we fetch the latest achievements...</p>
            </div>
            
            {/* Loading Skeleton */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="bg-slate-50 border border-slate-200 overflow-hidden animate-pulse">
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            <div className="max-w-md mx-auto text-center bg-slate-50 border border-slate-200 p-12">
              ...
              >
                We're preparing amazing achievements to showcase. Please check back soon!
              </motion.p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-slate-900 mb-4">Achievement Portfolio</h2>
              <p className="text-slate-600 text-lg">Comprehensive showcase of student excellence and institutional pride.</p>
            </motion.div>
                  ...
                  <Link href={`/prestasi/${achievement.id}`}>
                    <div className="relative">
                      ...
                      <div className="w-full h-48 relative bg-slate-100">
                        <Image
                          src={achievement.image || 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?q=80&w=1470&auto=format&fit=crop'}
          ...
          <div className="relative container mx-auto px-6 sm:px-8 lg:px-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <h2 className="text-3xl font-bold mb-4">Inspired by Excellence?</h2>
                <p className="text-slate-300 mb-8 text-lg">Join our community of high achievers and discover your potential for greatness.</p>
