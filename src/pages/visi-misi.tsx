import { useState, useEffect, FC, useCallback } from 'react'; // Tambahkan FC dan useCallback
...
const VisiMisiPage: FC = () => {
  ...
  useEffect(() => {
    fetchVisiMisi();
  }, [fetchVisiMisi]); // Tambahkan fetchVisiMisi sebagai dependensi useEffect
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 bg-white shadow-inner-lg rounded-t-3xl -mt-16 relative z-10">
        ...
        {!loading && error && (
          ...
          >
            ...
            <button
              onClick={fetchVisiMisi} // Panggil fungsi di sini
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            >
              ...
              <ul className="relative z-10 text-lg md:text-xl text-gray-800 space-y-4 list-disc pl-5">
                {visiMisiData.misi && visiMisiData.misi.map((item: string, index: number) => ( // Tipekan item dan index
                  <motion.li
                    key={index}
